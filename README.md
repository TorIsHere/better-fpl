...
| **Saves / 90 · CS** | Keeper tab only — their two real scoring sources (1 pt per 3 saves, 4 pts a clean sheet). High saves with few clean sheets is a busy keeper behind a poor defence: the classic budget pick. |
